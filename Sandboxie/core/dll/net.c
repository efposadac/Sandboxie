    ...
    void *pUnknown, BSTR imageFileName, ULONG_PTR pOrigImageNamePut)
{
    ...
    if (hFile != INVALID_HANDLE_VALUE) {
        ...
        BOOLEAN IsBoxedPath;
        NTSTATUS status = SbDll_GetHandlePath(hFile, path, &IsBoxedPath);
