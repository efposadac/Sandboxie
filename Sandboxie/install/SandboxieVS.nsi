...
;
    ...
    IfFileExists $INSTDIR\${SBDLL_DLL}      InstType_Upgrade
...
;
    ...
    File "/oname=$PLUGINSDIR\${SBDLL_DLL}" "${BIN_ROOT}\${SBDLL_DLL}"
...
WriteLoop:
    ...
    File /oname=${SBDLL_DLL} "${BIN_ROOT}\${SBDLL_DLL}"
...
!if "${_BUILDARCH}" == "x64"
    ...
    File /oname=32\${SBDLL_DLL} "${BIN_ROOT_Win32}\${SBDLL_DLL}"
